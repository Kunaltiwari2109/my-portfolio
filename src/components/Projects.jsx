...
const projects = [
  {
    ...
    description:
      "A full-stack e-commerce solution built with MERN stack. Features user authentication, payment integration, and a dynamic admin dashboard.",
  ...
  },
  {
    ...
    description:
      "A SaaS application that generates unique images using OpenAI API. Includes a credit system, user gallery, and premium subscription model.",
  ...
  },
  {
    ...
    description:
      "A beautiful, drag-and-drop task management tool focusing on smooth UI interactions and real-time database updates.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-neonPurple to-electricBlue">
              Digital Lab
            </span>
          </h2>
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="w-full h-full bg-backgroundSecondary flex flex-col items-center justify-center border-b border-white/10 group-hover:scale-110 transition-transform duration-700">
                  <div className="text-electricBlue/30 mb-2">
                    IMAGE PLACEHOLDER
                  </div>
                  <code className="text-xs text-textSecondary">
                    {project.image}
                  </code>
                </div>
              ...
              <div className="p-8 relative z-20 bg-gradient-to-b from-transparent to-backgroundPrimary">
                <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-electricBlue transition-colors">
                  {project.title}
                </h3>
                <p className="text-textSecondary mb-6 line-clamp-3 leading-relaxed">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {project.tech.map((tech, i) => (
                    <span
                      key={i}
                      className="text-xs font-medium px-3 py-1 rounded-full bg-white/5 text-electricBlue border border-electricBlue/20"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 text-sm text-textPrimary hover:text-white transition-colors"
                  >
                    <Github size={18} />
                    <span>Source</span>
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 text-sm text-electricBlue hover:text-white transition-colors ml-auto"
                  >
