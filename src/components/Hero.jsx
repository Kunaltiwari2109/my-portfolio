    ...
    >
      ...
      <div className="container mx-auto px-6 z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.p
            variants={fadeIn("up")}
            className="text-lg text-textSecondary max-w-lg mb-10 leading-relaxed"
          >
          ...
          <motion.div variants={fadeIn("up")} className="flex flex-wrap gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group relative px-8 py-4 rounded-lg glassmorphism border-glow hover:bg-white/10 transition-colors flex items-center gap-2 text-white font-semibold tracking-wide"
            >
              <Download
                size={20}
